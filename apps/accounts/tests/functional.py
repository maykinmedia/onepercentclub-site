...
class AccountSeleniumTests(ProjectTestsMixin, OnePercentSeleniumTestCase):
    ...
    def test_edit_account(self):
        ...
        self.browser.fill_form_by_label(fieldsets[2], [
            ('Account type', 'person'),
            ('Primary language', 'en'),
            # ('I want to share', [True, True]), # doesn't work because of hidden elements
        ])
    ...
    #     avatar_src = self.browser.find_by_css('li.nav-member a.nav-member-dropdown img').first['src']
